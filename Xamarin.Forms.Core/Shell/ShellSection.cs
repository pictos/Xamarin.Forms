...
namespace Xamarin.Forms
{
	...
	public class ShellSection : ShellGroupItem, IShellSectionController, IPropertyPropagationController
	{
		...
		async Task PrepareCurrentStackForBeingReplaced(NavigationRequest request, ShellRouteParameter queryData, bool? animate, List<string> globalRoutes)
		{
			string route = "";
		...
		Page GetOrCreateFromRoute(string route, ShellRouteParameter queryData, bool isLast)
		{
		...
		internal async Task GoToAsync(NavigationRequest request, ShellRouteParameter queryData, bool? animate)
		{
